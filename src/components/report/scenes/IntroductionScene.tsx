  ...
  return (
    ...
    >
      <GlitchLayer intensity='heavy' className='z-[50]'>
        ...
        />
        <Image
          src={mixintro_1Asset.url}
          alt='{mixintro_1Asset.alt}'
          width={mixintro_1Asset.width}
          height={mixintro_1Asset.height}
          className='object-contain absolute pointer-events-none select-none z-1'
        ...
        />
        <Image
          src={mixintro_2Asset.url}
          alt='{mixintro_2Asset.alt}'
          width={mixintro_2Asset.width}
          height={mixintro_2Asset.height}
          className='object-contain absolute pointer-events-none select-none z-1'
      ...
      <div className='z-[50] absolute inset-0'>
        <Image
          src={introTitleAsset.url}
          alt='{introTitleAsset.alt}'
          width={introTitleAsset.width}
          height={introTitleAsset.height}
          className='object-contain absolute pointer-events-none select-none z-1'
          ...
          >
            <Image
              ...
              className={`object-contain select-none cursor-pointer ${
                isAgreed ? 'animate-wiggle-x' : ''
              }`}
            />
            {/* Checkbox with text below the button */}
            <div
              className='flex items-center gap-2 mt-3'
              style={{ width: introButtonAsset.width + 40 }}
            >
              <input
                type='checkbox'
                id='data-agreement'
            ...
            <p
              className='text-black font-normal mt-3 text-center'
            ...
            <div className='flex-1 overflow-y-auto px-6 py-4'>
              <div className='text-sm text-[#373a40] leading-relaxed space-y-4'>
                ...
                <div className='agreement-content'>
                  ...
                  <p className='mb-4'>
                    您正式使用 2025 知乎个人年度报告----「我的 2025
                    真实源文件」（下称&ldquo;本服务&rdquo;）之前应仔细阅读并充分理解本协议中的全部内容，如您不同意本协议中的任何条款，请立即停止使用本服务。您使用本服务的行为将被视为已经仔细阅读、充分理解并毫无保留地接受本协议所有条款。
                  </p>
                  <p className='mb-4'>
                    您使用知乎 2025
                    年度报告应同时遵守《知乎协议》《知乎社区规范》等知乎平台规则。
                  </p>
                  <p className='mb-6'>
                  ...
                  {/* Section 1 */}
                  <h3 className='text-base font-semibold text-[#191b1f] mb-3 mt-6'>
                    1. 制作年度报告
                  </h3>
                  <p className='mb-3'>
                    知乎 2025 年度报告将根据您在知乎平台（包括不限于知乎网站，
                    PC、平板、手机、电视、机顶盒、穿戴设备、车内平板设备等全部终端客户端产品）的历史信息，帮助您生成专属年度报告。为此，知乎需要您授权我们使用您在知乎平台中的信息（含个人信息，具体以您在使用过程中实际产生的信息为准），主要包括：
                  </p>
                  <ul className='list-disc list-inside space-y-2 ml-4 mb-4'>
                    <li>
                      您的账号信息：昵称、头像、注册日期、注册天数、账号等级、性别等；
                    </li>
                    <li>
                      创作记录：发布内容（问题、回答、评论、文章、想法等）及其日期、数量、时间点（时间段）、所属领域、浏览/收藏/赞同/分享数据等；
                    </li>
                    <li>
                      激励：您公开获得的平台各类荣誉称号、活动奖项（如编辑推荐、知乎热榜、知势榜、商业影响力榜）等；
                    </li>
                    <li>
                      粉丝：包括关注您的用户数量、具体用户、点赞互动等公开信息；
                    </li>
                    <li>
                      浏览记录：您浏览的内容及其日期、数量、时间点（时间段）、所属领域等；
                    </li>
                    <li>互动数据：您的赞同、喜欢、浏览等互动数据；</li>
                    <li>
                      圈子数据：您加入/主理的圈子、圈内浏览、讨论、赞同数据；圈内互动用户等；
                    </li>
                    <li>
                      付费服务使用记录：您的各类知乎会员服务购买、使用记录（包括您阅读的内容数量）等；
                    </li>
                  </ul>
                  <p className='mb-4'>
                  ...
                  <p className='mb-4'>
                    您可依据年度报告页面提示的条件及规则领取「我的 2025
                    徽章」等奖励/权益，奖励/权益及其领取、使用等具体规则请以页面相关说明为准。
                  </p>
