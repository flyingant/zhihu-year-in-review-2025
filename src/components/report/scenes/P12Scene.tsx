...
export default function P12Scene({ onNext, sceneName }: PageProps) {
  ...
  // const earlyMorningHours = reportData?.early_morning_hours ?? null; // Not directly used in JSX labels
  ...
  return (
    <BaseScene onNext={onNext} sceneName={sceneName}>
      ...
      {/* 不同时段阅读足迹 */}
      <div style={{ paddingTop: '120px', paddingBottom: '10px', paddingLeft: '34px', paddingRight: '34px' }}>
