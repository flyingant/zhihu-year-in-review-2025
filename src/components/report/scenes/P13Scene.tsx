  ...
  return (
    <BaseScene onNext={onNext} sceneName={sceneName}>
      ...
      <div style={{ paddingLeft: '34px', paddingRight: '34px', paddingTop: '120px', fontSize: '14px' }}>
        ...
        <div style={{ paddingTop: '20px', paddingBottom: '20px' }} hidden={!consumeMostAnswerTitle || !consumeMostAnswerPvCnt || consumeMostAnswerPvCnt < 3}>
          <div>
            <span
              className="text-r-fern"
              style={{ fontSize: '18px', marginLeft: '4px', marginRight: '4px' }}
            >
            ...
            <div style={{ paddingTop: '8px' }}>
              ...
              次
              <div style={{ paddingTop: '8px' }}>那是你心底的珍藏吗？</div>
            </div>
