    ...
    <BaseScene onNext={onNext} sceneName={sceneName}>
      ...
      <GlitchLayer>
        ...
        <Image
          ...
          className="object-contain absolute top-[87px] left-[254px] pointer-events-none select-none z-1"
        />
        <Image
          src={mix22_4.url}
          alt="{mix22_4.alt}"
          ...
          className="object-contain absolute top-[578px] right-0 pointer-events-none select-none z-1"
        />
        <Image
          src={mix22_5.url}
          alt="{mix22_5.alt}"
          ...
          className="object-contain absolute top-[235px] left-[51px] pointer-events-none select-none z-1"
        />
        <Image
          src={mix22_5.url}
          alt="{mix22_5.alt}"
          width={mix22_5.width}
          height={mix22_5.height}
          className="object-contain absolute top-[736px] left-[24px] pointer-events-none select-none z-1"
        />
      </GlitchLayer>
      {/* images */}
      <div className="z-0">
        <Image
          ...
          width={film.width}
          height={film.height}
          className="object-contain absolute top-[17px] left-0 right-0 pointer-events-none select-none -z-10"
        />
        <Image
          src={liukanshan.url}
          alt="{liukanshan.alt}"
          ...
          className="object-contain absolute top-[578px] left-[45px] pointer-events-none select-none -z-10"
        />
      </div>
      {/* content */}
      <div className="z-0">
        ...
        {/* top films */}
        <div className="absolute top-[281px] left-0 right-0 z-0">
          <div className="flex h-[280px] justify-center text-sm">
            <div className="flex flex-col items-center w-[131px] text-center ">
              <Image
            ...
            <div className="flex flex-col items-center self-end w-[131px] space-y-[15px] text-center ">
              <Image
