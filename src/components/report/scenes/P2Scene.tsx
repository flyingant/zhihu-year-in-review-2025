...
export default function P2Scene({
  ...
  const questionCount = (reportData?.publish_question_cnt ?? null) as
    | number
    | null;
  const answerCount = (reportData?.question_answer_comment_cnt ?? null) as
    | number
    | null;
