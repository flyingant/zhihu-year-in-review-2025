    ...
    <BaseScene onNext={onNext} sceneName={sceneName}>
      <div className="z-0">
        ...
        <Image src={mix4Asset.url} alt="{mix4Asset.alt}" width={mix4Asset.width} height={mix4Asset.height} 
          className="object-contain absolute top-[339px] left-[0px] pointer-events-none select-none z-0" />
        <Image src={blue1Asset.url} alt="{blue1Asset.alt}" width={blue1Asset.width} height={blue1Asset.height} 
          className="object-contain absolute bottom-[267px] right-[150px] pointer-events-none select-none z-0" />
      ...
      <div className="z-0">
        <Image 
          ...
          className="w-full object-contain absolute bottom-[202px] left-[0%]  pointer-events-none select-none z-0" 
        />
        <Image 
