...
export default function P5EmojiScene({ onNext, sceneName }: PageProps) {
  ...
  return (
    <BaseScene onNext={onNext} sceneName={sceneName}>
      <GlitchLayer>
        <Image src={mix6Asset.url} alt="" width={mix6Asset.width} height={mix6Asset.height}
          className="object-contain absolute pointer-events-none select-none z-1"
          style={{ top: '15px', left: '-8px' }} />
        <Image src={mix3Asset.url} alt="" width={mix3Asset.width} height={mix3Asset.height}
          className="object-contain absolute pointer-events-none select-none z-1"
          style={{ top: '152px', right: '0px' }} />
        <Image src={blue2Asset.url} alt="" width={blue2Asset.width} height={blue2Asset.height}
          className="object-contain absolute pointer-events-none select-none z-1"
          style={{ bottom: '267px', right: '56px' }} />
        <Image src={mix5Asset.url} alt="" width={mix5Asset.width} height={mix5Asset.height}
          className="object-contain absolute pointer-events-none select-none z-1"
      ...
      <div className="z-1">
        <Image
          src={yellowMirrorAsset.url} alt="" width={yellowMirrorAsset.width} height={yellowMirrorAsset.height}
          className="object-contain absolute pointer-events-none select-none z-1"
          style={{ bottom: '49px', left: '0px' }}
        />
        <Image
          src={liukanshanPixelAsset.url} alt="" width={liukanshanPixelAsset.width} height={liukanshanPixelAsset.height}
          className="object-contain absolute pointer-events-none select-none z-1"
          style={{ bottom: '73px', left: '26px' }}
        />
        <Image
          src={hiAsset.url} alt="" width={hiAsset.width} height={hiAsset.height}
        ...
        <Image
          ...
          style={{ bottom: '212px', right: '93px', animationDelay: '2s', transformOrigin: 'bottom center' }}
        />
      </div>
