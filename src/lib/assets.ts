...
export const assets = {
  ...
  newImages: {
    ...
    sidebarLiuKanshanCancel: {
      url: '/assets/sidebar_liukanshan_cancel@3x.png',
      width: 909,
      height: 279,
      alt: '取消',
    },
    ...
    sidebarLiuKanshanPublishPc: {
      url: '/assets/sidebar_liukanshan_publish_pc@3x.png',
      width: 909,
      height: 944,
      alt: '发布-PC',
    },
    sidebarLiuKanshanQrcode: {
      url: '/assets/sidebar_liukanshan_qrcode@3x.png',
      width: 522,
      height: 522,
      alt: '二维码',
    },
    sidebarLiuKanshanQrcodeTips: {
      url: '/assets/sidebar_liukanshan_qrcode_tips@3x.png',
      width: 597,
      height: 168,
      alt: '请打开知乎 App 扫码 继续完成发布',
    },
